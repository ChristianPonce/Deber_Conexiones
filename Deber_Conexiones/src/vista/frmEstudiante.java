...
public class frmEstudiante extends javax.swing.JFrame {
                    ...
                    .addGroup(pnlEstudianteLayout.createSequentialGroup()
                        .addGroup(pnlEstudianteLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(pnlEstudianteLayout.createSequentialGroup()
                                ...
                                .addGroup(pnlEstudianteLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(cbGenero, javax.swing.GroupLayout.PREFERRED_SIZE, 108, javax.swing.GroupLayout.PREFERRED_SIZE)
                            ...
                            .addGroup(pnlEstudianteLayout.createSequentialGroup()
                                ...
                                .addGroup(pnlEstudianteLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(cbMateria, javax.swing.GroupLayout.PREFERRED_SIZE, 107, javax.swing.GroupLayout.PREFERRED_SIZE))))
    ...
    private void btnDerechaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDerechaActionPerformed
        ...
        try {
            ...
            aux = n - 1;
            if (codigo >= aux) {
                JOptionPane.showMessageDialog(null, "ULTIMO estudiante de la lista");
                codigo = aux - 1;
            }
            codigo++;
            ps = conexion.prepareStatement("select * from estudiante where codigoE=?");
            ...
            if (rs.next()) {
                ...
                cbMateria.setSelectedItem(rs.getString("materia"));
                txtNota.setText(String.valueOf(rs.getDouble("nota")));
                txtBuscar.setText(String.valueOf(datos[codigo]));
            } else {
                JOptionPane.showMessageDialog(null, "No existe el registro");
            }
            conexion.close();
    ...
    private void btnIzquierdaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIzquierdaActionPerformed
        ...
        try {
            ...
            if (codigo <= 0) {
                codigo = 1;
                JOptionPane.showMessageDialog(null, "PRIMER estudiante de la lista");
            }
            codigo--;
            ps = conexion.prepareStatement("select * from estudiante where codigoE=?");
            ps.setInt(1, Integer.parseInt(String.valueOf(datos[codigo])));
