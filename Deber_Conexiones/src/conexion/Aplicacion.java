...
public class Aplicacion extends javax.swing.JFrame {    
  ...
  //  public static final String URL ="jdbc:mysql://localhost:3306/gauss?zeroDateTimeBehavior=CONVERT_TO_NULL";
    public static final String USUARIO ="root";
    public static final String CLAVE ="1997";     
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
          ...
          try{
              ...
              while(rs.next())
              {
                  JOptionPane.showMessageDialog(null,rs.getString("nombreE")+"  "+rs.getBigDecimal("nota"));
              }
          }catch(Exception ex){
